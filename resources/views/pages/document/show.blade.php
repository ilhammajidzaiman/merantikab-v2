<x-public.layout.app-layout title="{{ $record->title ?? null }}">
                    ...
                    @if ($record->slug)
                        <div class="col-span-full md:col-span-4">
                            <div class="flex space-x-2 items-center font-normal text-md text-slate-600 mb-4">
                                <a wire:navigate href="{{ route('document.index') }}"class="hover:underline">
                                    Dokumen
                                </a>
                                ...
                                <a wire:navigate
                                    href="{{ route('document.index') }} "class="hover:underline text-emerald-500 line-clamp-1">
                                    {{ $record->title ?? null }}
                                </a>
                            </div>
                            ...
                            <div class="mt-4 flex justify-start">
                                <a href="{{ route('document.download', $record->slug) }}"
    ...
    @if ($record->slug)
        @push('metaTag')
            @if ($record)
                <meta property="og:url" content="{{ route('document.show', $item->slug ?? null) }}">
                ...
                <meta property="twitter:domain" content="{{ route('document.show', $item->slug ?? null) }}">
                <meta property="twitter:url" content="{{ route('document.show', $item->slug ?? null) }}">
        ...
        @push('scripts')
            <script>
                const url = "{{ route('document.show', $item->slug ?? null) }}";
