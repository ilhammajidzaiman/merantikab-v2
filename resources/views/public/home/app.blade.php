<section id="app" class="w-full p-3">
    <div
        class="bg-emerald-500 bg-[url(/public/image/background/subtle-prism.svg)] bg-center bg-fixed bg-repeat rounded-xl p-3 py-12">
            ...
            <div class="w-full sm:max-w-6xl md:max-w-6xl mx-auto p-3">
                <div class="w-full flex justify-center">
                    <div class="space-y-2 text-center">
                        ...
                        <h3 class="text-xl">
                            {{ Str::title(__('kurasi tautan situs layanan pemerintahan')) }}
                        </h3>
                        <div
                            class="w-full md:w-xl h-0.5 mx-auto bg-gradient-to-r from-transparent via-white to-transparent">
                        </div>
                    </div>
                </div>
