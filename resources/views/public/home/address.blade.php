<div class="w-full">
    <div class="w-full sm:max-w-6xl md:max-w-6xl mx-auto space-y-8 p-3">
        ...
        <div class="bg-white rounded-xl overflow-hidden shadow p-3">
    ...
    3 3 0 0 0 0 6Z" clip-rule="evenodd" />
                        ...
                        <h3 class="">Jalan Dorak, Kec. Tebing Tinggi, Selatpanjang - 28771</h3>
                    </div>
                    <div class="mt-4 flex items-start space-x-2">
                        <div class="w-fit">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <div class="mt-4 flex items-start space-x-2">
                        ...
                        <h3 class="">diskominfotik@merantikab.go.id</h3>
                    </div>
                </div>
            </div>
        </div>
