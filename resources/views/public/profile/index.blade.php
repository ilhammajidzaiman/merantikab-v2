...
<x-public.layout.app-layout title="{{ Str::title(__('selayang pandang')) }}">
                    ...
                    <div class="h-full flex-col md:flex-row py-10 flex space-y-4">
                        ...
                        <div class="flex-3 flex items-center justify-center">
                            <div class="space-y-2">
                                ...
                                <h1 class="text-5xl font-bold font-nacelle text-white">Kepulauan Meranti</h1>
                                <p class="text-lg text-white">
                                    Memperkenalkan permata muda di Provinsi Riau. Mengilhami kekaguman dengan dedikasi
                                    yang tak kenal lelah dan terus bekerja keras menjadi kabupaten yang maju, cerdas,
                                    dan bermartabat
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-span-full md:col-span-4">
                        <div class="sticky top-[50%] space-y-4">
                            ...
                            <p class="mb-4 text-lg text-slate-500">
                                Visi dan misi merupakan panduan yang akan mengarahkan langkah-langkah Kabupaten
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-full">
                                        ...
                                        <div
                                            ...
                                            <h1>
                                                Menjadikan Kabupaten Kepulauan Meranti Unggul, Agamis, dan Sejahtera
                                            </h1>
                                        </div>
                                    </div>
                                    <div class="col-span-full">
                                        ...
                                        <div
                                            ...
                                            <ul class="text-lg text-slate-600 space-y-4">
                                                <li class="flex space-x-4">
                                                    <p>1.</p>
                                                    <p>Memperkuat Tata Kelola Pemerintahan yang Baik, Bersih,
                                                        Transparan,
                                                        Bertanggung Jawab Serta Pelayanan Urusan Masyarakat yang Mudah
                                                        dan
                                                        Nyaman</p>
                                                </li>
                                                <li class="flex space-x-4">
                                                    <p>2.</p>
                                                    <p>Peningkatan dan Pemerataan Infrastruktur di Wilayah Kabupaten
                                                        Kepulauan
                                                        Meranti dengan Memperhatikan Kelestarian Lingkungan</p>
                                                </li>
                                                <li class="flex space-x-4">
                                                    <p>3.</p>
                                                    <p>Memperkuat Sarana Prasarana Transportasi Laut dan Darat Antar
                                                        Pulau Dalam
                                                        Daerah, Luar Daerah dan Lintas Perbatasan</p>
                                                </li>
                                                <li class="flex space-x-4">
                                                    <p>4.</p>
                                                    <p>Memperkuat Mutu dan Jaminan Pendidikan Sesuai Kebutuhan
                                                        Industri Birokrasi
                                                        dan Kewirausahaan</p>
                                                </li>
                                                <li class="flex space-x-4">
                                                ...
                                                <li class="flex space-x-4">
                                                    <p>6.</p>
                                                    <p>Meningkatkan Sektor Ekonomi Pertanian, Perkebunan, Perikanan,
                                                        Ekonomi
                                                        Kreatif Dan UMKM, Melalui Pemberdayaan dan Kemandirian Usaha
                                                    </p>
                                                </li>
                                                <li class="flex space-x-4">
                                                    <p>7.</p>
                                                ...
                                                <li class="flex space-x-4">
                                                    <p>8.</p>
                                                    <p>Meningkatkan Peran Serta Masyarakat Dalam Pengambilan Arah
                                                        Kebijakan dan
                    ...
                    <div class="w-full md:w-3/5">
                        <div class="space-y-2">
                            ...
                            <p class="text-base text-slate-600">
                                Kepulauan Meranti adalah sebuah kabupaten di Provinsi Riau, Indonesia dengan ibukota
                                Selatpanjang. Jumlah penduduk di kabupaten ini mencapai
                                206.116 jiwa (2020) dengan luas wilayah seluas 3.707,84 km². Wilayah ini terdiri dari 15
                                pulau, termasuk Pulau Merbau, Pulau Ransang, dan Pulau Tebing Tinggi.
                            </p>
                            <p class="text-base text-slate-600">
                                Keadaan geografi Kabupaten Kepulauan Meranti didominasi oleh daratan rendah dengan tanah
                                alluvial dan grey humus. Wilayah ini sangat cocok untuk pertanian, perkebunan, dan
                                perikanan.
                            </p>
                        </div>
                    </div>
