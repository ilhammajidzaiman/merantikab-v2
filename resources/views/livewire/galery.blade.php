                        ...
                        <div class="relative w-full">
                            <div class="mt-4 grid grid-cols-1">
                                <select wire:model.live="type" name="type" id="type"
                                    class="col-start-1 row-start-1 w-full appearance-none rounded-lg shadow-md bg-slate-100 text-slate-700 px-5 py-3 pl-13 focus:ring-1 focus:ring-emerald-500 focus:outline-none outline-gray-300 focus:outline-emerald-600">
