                            ...
                            <div tabindex="0" class="fixed inset-0 focus:outline-none">
                                <el-dialog-panel
                                    ...
                                    <div class="flex items-center justify-between">
                                        <a href="{{ route('index') }}">
                                            <div
                                                class="flex items-center justify-center md:justify-start w-full gap-2">
                                                <img src="{{ asset('image/logo-meranti.png') }}" alt="Logo"
                                                    class="w-12 h-12 object-contain" />
                                    ...
                                    <div class="mt-6 flow-root">
                                        <div class="-my-6 divide-y divide-gray-500/10">
                                            <div class="space-y-2 py-6">
                                                <a href="{{ route('index') }}"
                                                    class="-mx-3 block rounded-xl px-3 py-2 text-normal/7 font-semibold text-gray-900 hover:bg-gray-50">Beranda</a>
                                                <div class="-mx-3">
